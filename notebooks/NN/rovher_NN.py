...
metrics_file = f"{ROOTDIR}/{REGION}_VARWIN{VAR_WIN}_{y_label}_AUC.csv"
...
if ANNO_COLS == "yes":
    if data.isnull().values.any():
        ...
        sys.exit(1)
    data2 = data.drop(columns=['PLINK_SNP_NAME','height_FDR','rovher_score','Gene.refGene'], errors='ignore')
